...
private:
    ...
    vector<string> lvl15names = {"Andor Muzzler", "Power Node", "Blade Reaper", "Sanitor", "Edge Night", "Needler", "Haxmoor", "Seeker Baldes", "World Madder", "Knight of Wren", "Blasterd", "Feternyl", "Darvor", "Syren", "Shard of Darkness", "Hunters", "Artemis", "Dackter", "Waere Master", "Fiend of Light", "Advents Bane"};
public:
    ...
    vector<string> Monster2 (vector<string> enemy, int difficulty);
